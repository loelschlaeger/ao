...
- `iteration_limit` is the maximum number of AO iterations before termination, this value can also be `Inf`

- `tolerance_value` is a positive threshold which is the minimum absolute change in the function value in two consecutive iterations before the procedure is terminated
